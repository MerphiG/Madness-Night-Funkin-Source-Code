...
class FreeplayStory extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In Freeplay Story Songs", null);
		#end
		...
		var initSonglist = CoolUtil.coolTextFile(Paths.txt('freeplaySonglistStory'));
